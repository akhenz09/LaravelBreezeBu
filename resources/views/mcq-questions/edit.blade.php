...
<form action="{{ route('mcq-questions.store') }}" method="POST">
    ...
    <div class="max-w-7xl sm:px-6 lg:px-8 form-group p-2">
        ...
        <input type="text" name="option_e" class="form-control" value="{{ $question->option_e }}" required>
    </div>
    </div>
    <div class="flex flex-col items-center max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="max-w-7xl sm:px-6 lg:px-8 form-group p-2">
    ...
    <button type="submit" class="flex flex-col items-end px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white rounded-md">Update</button>
    </div>
</form>
                </div>
            </div>
